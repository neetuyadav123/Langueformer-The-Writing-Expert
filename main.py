...
from bs4 import BeautifulSoup  #package
...
st.set_page_config(  
    ...
    initial_sidebar_state="expanded"  # by default side bar is expended you can also minimize the side bas
)

print('Wait...Model is loading!!!')

class Style_Demo:           #this is class for styleformer
